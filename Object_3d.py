...
class Object_3d:
    ...
    def screen_projection(self):
        vertexes = self.vertexes @ self.render.view.view_matrix()
    ...
    def translate(self, point):
        self.vertexes = self.vertexes @ translate_M(point)

    def scale(self, scale_to):
        self.vertexes = self.vertexes @ scale_M(scale_to)
